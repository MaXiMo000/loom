  ...
  return (
    <div className="legend">
      ...
      <div className="legend-note">
        Showing {scan.nodes.length} dependencies, depth-capped at {scan.depth_cap} levels
        (SPEC.md §7.2). Drift and policy signals are always <code>unverified</code> in
        this phase — not computed yet.
      </div>
    </div>
  )
}
